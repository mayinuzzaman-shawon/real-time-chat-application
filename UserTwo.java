...
public class UserTwo implements ActionListener, Runnable{
    ...
    UserTwo(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/female_profile_pic2.png"));
        ...
        JLabel name = new JLabel("CS Group 24");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SANS_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Sara, John, Jennifer, Aaron, Shawn");
